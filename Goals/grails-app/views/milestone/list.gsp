			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="name" title="${message(code: 'milestone.name.label', default: 'Name')}" />
					
						<g:sortableColumn property="description" title="${message(code: 'milestone.description.label', default: 'Description')}" />
				...
				<g:each in="${milestoneInstanceList}" status="i" var="milestoneInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${milestoneInstance.id}">${fieldValue(bean: milestoneInstance, field: "name")}</g:link></td>
